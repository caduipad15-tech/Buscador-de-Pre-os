...
# Estilização CSS com as cores exatas solicitadas e fonte chamativa
st.markdown("""
    ...
    <style>
        ...
        /* 1. BASIC - Onde estava roxo agora é VERDE CLARO */
        .card-basic {
        ...
        /* 2. PLUS - Onde estava vermelho agora é VERDE ESCURO */
        .card-plus {
        ...
        /* 3. PREMIUM - Onde estava amarelo agora é DOURADO BRILHANTE COM GLOW */
        .card-premium {
...
with col_f1:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #4ade80; font-weight: 700; margin-bottom: 10px;">1. Busque o produto</h4>
...
with col_f2:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #4ade80; font-weight: 700; margin-bottom: 10px;">2. Compare e Proteja-se</h4>
...
with col_f3:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #4ade80; font-weight: 700; margin-bottom: 10px;">3. Economize de verdade</h4>
...
with col_v1:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #4ade80; font-weight: 700; margin-bottom: 8px;">🛡️ Zero risco de cair em golpes</h4>
        ...
        <div class="section-box">
            <h4 style="color: #4ade80; font-weight: 700; margin-bottom: 8px;">💰 Economia real com frete incluso</h4>
...
with col_v2:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #4ade80; font-weight: 700; margin-bottom: 8px;">🤖 Inteligência para grandes compras</h4>
        ...
        <div class="section-box">
            <h4 style="color: #4ade80; font-weight: 700; margin-bottom: 8px;">🔔 Avisos no momento certo</h4>
