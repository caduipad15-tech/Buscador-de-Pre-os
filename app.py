...
# Estilização CSS personalizada com tema escuro, fontes chamativas e cores solicitadas
st.markdown("""
    @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700;800;900&display=swap');

    <style>
        /* Força fundo escuro e a fonte Poppins em tudo */
        .stApp { 
        ...
        /* Estilização de Preços Gigantes (Estilo Referência) */
        .preco-gigante {
            font-size: 42px;
            font-weight: 900;
        ...
        /* Botões Estilizados e Chamativos */
        ...
        /* Seletor Mensal/Anual Centralizado */
        div[role="radiogroup"] { 
...
with col1:
    ...
    """, unsafe_allow_html=True)
    st.button("Iniciar 7 dias grátis", key="btn_basic", use_container_width=True)
...
with col2:
    ...
    st.markdown(f"""
        <div class="card-base card-plus">
            <div>
                ...
                <div class="sub-info" style="color: #38bdf8;">{sub_plus}</div>
                <ul class="lista-beneficios">
                    <li>✓ Comparação de preços</li>
                    <li>✓ Preço final com frete</li>
                    <li>✓ Histórico de preços</li>
    ...
    """, unsafe_allow_html=True)
    st.button("Assinar Plus", key="btn_plus", use_container_width=True)
...
with col3:
    ...
    st.markdown(f"""
        <div class="card-base card-premium">
            <div>
                ...
                <div class="sub-info" style="color: #fbbf24;">{sub_premium}</div>
                <ul class="lista-beneficios">
                    <li>✓ Comparação de preços</li>
                    <li>✓ Preço final com frete</li>
                    <li>✓ Histórico de preços</li>
    ...
    """, unsafe_allow_html=True)
    st.button("Assinar Premium", key="btn_premium", use_container_width=True)
...
with col_f1:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #38bdf8; font-weight: 700; margin-bottom: 10px;">1. Busque o produto</h4>
            <p style="font-size: 13px; color: #9ca3af; margin:0;">Digite o que você quer comprar. Nossa tecnologia varre a internet inteira em segundos.</p>
        </div>
    """, unsafe_allow_html=True)
...
with col_f2:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #38bdf8; font-weight: 700; margin-bottom: 10px;">2. Compare e Proteja-se</h4>
            <p style="font-size: 13px; color: #9ca3af; margin:0;">Mostramos o preço real com frete, histórico de valores e alertamos se a loja é segura contra golpes.</p>
        </div>
    """, unsafe_allow_html=True)
...
with col_f3:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #38bdf8; font-weight: 700; margin-bottom: 10px;">3. Economize de verdade</h4>
            <p style="font-size: 13px; color: #9ca3af; margin:0;">Ative alertas de preço, receba cupons ou use nossa IA para planejar orçamentos completos.</p>
        </div>
    """, unsafe_allow_html=True)
...
with col_v1:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #38bdf8; font-weight: 700; margin-bottom: 8px;">🛡️ Zero risco de cair em golpes</h4>
            <p style="font-size: 13px; color: #9ca3af; margin:0;">Nossa análise inteligente identifica sinais suspeitos em lojas virtuais antes de você colocar o cartão de crédito.</p>
        </div>
        <div class="section-box">
            <h4 style="color: #38bdf8; font-weight: 700; margin-bottom: 8px;">💰 Economia real com frete incluso</h4>
            <p style="font-size: 13px; color: #9ca3af; margin:0;">Não adianta o produto estar barato se o frete for absurdo. Calculamos o valor final para você não ter surpresas.</p>
        </div>
    """, unsafe_allow_html=True)
...
with col_v2:
    st.markdown("""
        <div class="section-box">
            <h4 style="color: #38bdf8; font-weight: 700; margin-bottom: 8px;">🤖 Inteligência para grandes compras</h4>
            <p style="font-size: 13px; color: #9ca3af; margin:0;">Quer mobiliar a casa inteira? Nossa IA monta o carrinho ideal respeitando exatamente o seu orçamento máximo.</p>
        </div>
        <div class="section-box">
            <h4 style="color: #38bdf8; font-weight: 700; margin-bottom: 8px;">🔔 Avisos no momento certo</h4>
            <p style="font-size: 13px; color: #9ca3af; margin:0;">Defina quanto quer pagar e seja avisado por notificação ou WhatsApp assim que o preço cair para a sua meta.</p>
        </div>
    """, unsafe_allow_html=True)
